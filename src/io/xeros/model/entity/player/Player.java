...
import io.xeros.content.dailytasks.TaskTypes;
...
import io.xeros.new_quest_tab.AchievementTab;
import io.xeros.new_quest_tab.EventTab;
import io.xeros.new_quest_tab.GeneralTab;
import io.xeros.new_quest_tab.PersonalTab;
   ...
   // public Player tournamentTarget;
    ...
    public void finishLogin() {
        ...
        if (totalLevel >= 2178) {
            ...
            io.xeros.achievements.AchievementHandler.activate(this, AchievementList.MAX, 1);
        }
...
//New system for achievements
    ...
    private io.xeros.achievements.AchievementHandler.AchievementDifficulty achievementPage;
    public io.xeros.achievements.AchievementHandler.AchievementDifficulty getAchievement() {
