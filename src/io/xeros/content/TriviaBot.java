...
public class TriviaBot {
	...
	private static final String[][] TRIVIA_DATA = {
			...
			{"@red@ Trivia:</col> <col=6666FF>What is one commitment that will help Vanguard grow ?", "vote"},
			...
			{"@red@ Trivia:</col> <col=6666FF>Who is the owner of Vanguard ?", "Grim"},
			...
			{"@red@ Trivia:</col> <col=6666FF>What is currently the max combat level on Vanguard ?", "126"},
			{"@red@ Trivia:</col> <col=6666FF>What's currently the max total level on Vanguard ?", "2178"},
