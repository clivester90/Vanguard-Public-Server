...
public class WeaponDataConstants {
    ...
    public static final int[] CRUSH_SWORDS = {
        ...
        Items.DRAGON_2H_SWORD, Items.ARMADYL_GODSWORD, Items.SARADOMIN_GODSWORD, Items.ZAMORAK_GODSWORD, Items.BANDOS_GODSWORD, 26233,
    ...
    public static final int[] NEWSCYTHE = {// added for custom spec bars
            25736,
    };
    ...
    public static final int[] STAB_SWORDS = {
        ...
        Items.WILDERNESS_SWORD_1, Items.WILDERNESS_SWORD_2, Items.WILDERNESS_SWORD_3, Items.WILDERNESS_SWORD_4, 25734
    };
    ...
    public static final int[] WARHAMMERS = {
            ...
            Items.GRANITE_MAUL, Items.GRANITE_MAUL_OR, 24158
    };

    // [[accurate, slash], [shared, slash], [defensive, slash]]
    public static final int[] WHIPS = {
            Items.ABYSSAL_WHIP, Items.FROZEN_ABYSSAL_WHIP, Items.VOLCANIC_ABYSSAL_WHIP, Items.ABYSSAL_TENTACLE, 26484 ,
    };
   ...
   public static final int[] STANDARD_STAFFS = {
           ...
           Items.IBANS_STAFF, Items.IBANS_STAFF_U, Items.ZURIELS_STAFF, 25731
   };
    ...
    public static final int[] BOWS = {
            //Crossbows
            Items.CROSSBOW, Items.BRONZE_CROSSBOW, Items.IRON_CROSSBOW, Items.STEEL_CROSSBOW,  Items.MITH_CROSSBOW, Items.ADAMANT_CROSSBOW, 23145,
            Items.RUNE_CROSSBOW, Items.DRAGON_CROSSBOW, Items.ARMADYL_CROSSBOW,  Items.KARILS_CROSSBOW, 26374,
            Items.BLURITE_CROSSBOW,
            //Special Crossbows
            Items.PHOENIX_CROSSBOW, Items.LIGHT_BALLISTA, Items.HEAVY_BALLISTA, Items.DRAGON_HUNTER_CROSSBOW, 24119, Items.DORGESHUUN_CROSSBOW, Items.HUNTERS_CROSSBOW,
            //Shortbows
            ...
            //Special Bows
            Items.CURSED_GOBLIN_BOW, Items.TRAINING_BOW, Items.OGRE_BOW, Items.DARK_BOW, Items.CRYSTAL_BOW, Items.TWISTED_BOW, 24111, Items.CRAWS_BOW,
            Items.DARK_BOW_BLUE, Items.DARK_BOW_GREEN,Items.DARK_BOW_YELLOW,Items.DARK_BOW_WHITE, Items.THIRD_AGE_BOW,



            // Crystal bows
            412, 4213, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223, 20999, 25867
    ...
    public static final int[] THROWN = {
            ...
            //Darts
            Items.BRONZE_DART, Items.IRON_DART, Items.STEEL_DART, Items.BLACK_DART, Items.MITHRIL_DART, Items.ADAMANT_DART, Items.RUNE_DART, Items.DRAGON_DART, 25849,
            //Thrownaxe
            ...
            //Special Thrown
            Items.TOKTZ_XIL_UL, Items.CHINCHOMPA_2, Items.RED_CHINCHOMPA_2, Items.BLACK_CHINCHOMPA, Items.TOXIC_BLOWPIPE, 24106,
   };
