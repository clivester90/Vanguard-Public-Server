package io.runescape.model.collisionmap;
...
public class Region {
    ...
    private static final ArrayList<WorldObject> worldObjectsTest = new ArrayList<>();
    ...
    public static Optional<WorldObject> getWorldObjectTest(int id, int x, int y, int height) {
        final int z = height % 4;
        return worldObjectsTest.stream().filter(object -> object.id == id && object.x == x && object.y == y && object.height == z).findFirst();
    }
    ...
    public static void addWorldObjectTest(int id, int x, int y, int height, int type, int face) {
        int z = height % 4;
        worldObjectsTest.add(new WorldObject(id, x, y, z, type, face));
    }
    ...
    public static void addWorldObjectTest(WorldObject object) {
        addWorldObjectTest(object.getId(), object.getX(), object.getY(), object.getHeight(), object.getType(), object.getFace());
    }
