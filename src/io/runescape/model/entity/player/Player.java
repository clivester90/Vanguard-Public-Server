...
import io.runescape.content.achievement.AchievementHandler;
import io.runescape.content.achievement_diary.AchievementDiaryManager;
import io.runescape.content.achievement_diary.RechargeItems;
import io.runescape.content.barrows.Barrows;
import io.runescape.content.bosses.Cerberus;
import io.runescape.content.bosses.Nex;
import io.runescape.content.bosses.Skotizo;
import io.runescape.content.bosses.Vorkath;
import io.runescape.content.bosses.godwars.God;
import io.runescape.content.bosses.godwars.Godwars;
...
import io.runescape.content.bosspoints.BossPoints;
import io.runescape.content.cheatprevention.RandomEventInterface;
import io.runescape.content.collection_log.CollectionLog;
import io.runescape.content.combat.CombatItems;
import io.runescape.content.combat.EntityDamageQueue;
import io.runescape.content.combat.Hitmark;
import io.runescape.content.combat.core.AttackEntity;
import io.runescape.content.combat.death.PlayerDeath;
import io.runescape.content.combat.effects.damageeffect.impl.amuletofthedamned.impl.ToragsEffect;
import io.runescape.content.combat.formula.MeleeMaxHit;
import io.runescape.content.combat.magic.CombatSpellData;
import io.runescape.content.combat.melee.CombatPrayer;
import io.runescape.content.combat.melee.MeleeData;
import io.runescape.content.combat.melee.MeleeExtras;
import io.runescape.content.combat.melee.QuickPrayers;
import io.runescape.content.combat.pvp.Killstreak;
import io.runescape.content.combat.stats.BossTimers;
import io.runescape.content.combat.stats.NPCDeathTracker;
import io.runescape.content.combat.weapon.CombatStyle;
import io.runescape.content.combat.weapon.WeaponMode;
import io.runescape.content.compromised.CompromisedAccounts;
import io.runescape.content.dailyrewards.DailyRewards;
import io.runescape.content.dailytasks.DailyTasks;
import io.runescape.content.dailytasks.TaskTypes;
import io.runescape.content.dialogue.DialogueBuilder;
import io.runescape.content.dialogue.DialogueOption;
import io.runescape.content.donationrewards.DonationRewards;
import io.runescape.content.dwarfmulticannon.Cannon;
...
import io.runescape.content.event.eventcalendar.EventChallengeMonthlyReward;
import io.runescape.content.hs.Highscore;
import io.runescape.content.item.lootable.impl.*;
import io.runescape.content.item.lootable.unref.*;
import io.runescape.content.items.Degrade;
import io.runescape.content.items.PvpWeapons;
import io.runescape.content.items.RingOfKoranes;
import io.runescape.content.items.RingOfKoranesImbue;
import io.runescape.content.items.pouch.GemBag;
import io.runescape.content.items.pouch.HerbSack;
import io.runescape.content.items.pouch.RunePouch;
import io.runescape.content.itemskeptondeath.perdu.PerduLostPropertyShop;
import io.runescape.content.lootbag.LootingBag;
import io.runescape.content.minigames.LastManStanding;
import io.runescape.content.minigames.bounty_hunter.BountyHunter;
import io.runescape.content.minigames.fight_cave.FightCave;
import io.runescape.content.minigames.inferno.Inferno;
import io.runescape.content.minigames.pest_control.PestControl;
import io.runescape.content.minigames.pest_control.PestControlRewards;
import io.runescape.content.minigames.pk_arena.Highpkarena;
import io.runescape.content.minigames.pk_arena.Lowpkarena;
import io.runescape.content.minigames.raids.RaidConstants;
import io.runescape.content.minigames.raids.Raids;
import io.runescape.content.minigames.tob.TobConstants;
import io.runescape.content.minigames.tob.TobContainer;
import io.runescape.content.minigames.tob.instance.TobInstance;
import io.runescape.content.minigames.warriors_guild.WarriorsGuild;
import io.runescape.content.minigames.xeric.XericLobby;
import io.runescape.content.miniquests.MageArena;
...
import io.runescape.content.preset.Preset;
import io.runescape.content.prestige.PrestigeSkills;
import io.runescape.content.privatemessaging.FriendsList;
import io.runescape.content.questing.Questing;
import io.runescape.content.skills.Agility;
import io.runescape.content.skills.ExpLock;
import io.runescape.content.skills.Skill;
import io.runescape.content.skills.SkillInterfaces;
import io.runescape.content.skills.agility.AgilityHandler;
import io.runescape.content.skills.agility.impl.*;
import io.runescape.content.skills.agility.impl.rooftop.*;
import io.runescape.content.skills.farming.Farming;
import io.runescape.content.skills.fletching.Fletching;
import io.runescape.content.skills.herblore.Herblore;
import io.runescape.content.skills.hunter.Hunter;
import io.runescape.content.skills.mining.Mining;
import io.runescape.content.skills.prayer.Prayer;
import io.runescape.content.skills.slayer.Slayer;
import io.runescape.content.skills.smithing.Smelting;
import io.runescape.content.skills.smithing.Smithing;
import io.runescape.content.skills.smithing.SmithingInterface;
import io.runescape.content.skills.thieving.Thieving;
import io.runescape.content.teleportation.inter.TeleportInterface;
import io.runescape.content.titles.Titles;
import io.runescape.content.trails.TreasureTrails;
import io.runescape.content.tutorial.ModeSelection;
import io.runescape.content.tutorial.TutorialDialogue;
import io.runescape.content.upgrade.UpgradeData;
import io.runescape.content.upgrade.UpgradeHandler;
import io.runescape.content.upgrade.UpgradeType;
...
import io.runescape.model.controller.Controller;
import io.runescape.model.controller.ControllerRepository;
import io.runescape.model.cycleevent.CycleEventHandler;
import io.runescape.model.cycleevent.Event;
import io.runescape.model.cycleevent.impl.MinigamePlayersEvent;
import io.runescape.model.cycleevent.impl.RunEnergyEvent;
import io.runescape.model.cycleevent.impl.SkillRestorationEvent;
...
import io.runescape.model.entity.player.lock.PlayerLock;
import io.runescape.model.entity.player.lock.Unlocked;
import io.runescape.model.entity.player.migration.PlayerMigrationRepository;
import io.runescape.model.entity.player.mode.Mode;
import io.runescape.model.entity.player.mode.ModeRevertType;
import io.runescape.model.entity.player.mode.ModeType;
import io.runescape.model.entity.player.mode.RegularMode;
import io.runescape.model.entity.player.mode.group.GroupIronmanGroup;
import io.runescape.model.entity.player.mode.group.GroupIronmanRepository;
import io.runescape.model.entity.player.packets.ChangeAppearance;
...
import io.runescape.model.items.bank.Bank;
import io.runescape.model.items.bank.BankPin;
import io.runescape.model.lobby.LobbyManager;
import io.runescape.model.lobby.LobbyType;
import io.runescape.model.lobby.impl.LastManStandingLobby;
...
import io.runescape.model.multiplayersession.duel.Duel;
...
import io.runescape.model.multiplayersession.flowerpoker.FlowerPokerHand;
import io.runescape.model.multiplayersession.trade.Trade;
import io.runescape.model.shops.ShopAssistant;
import io.runescape.model.tickable.Tickable;
import io.runescape.model.tickable.TickableContainer;
import io.runescape.model.timers.TickTimer;
import io.runescape.model.world.Clan;
import io.runescape.net.Packet;
import io.runescape.net.PacketBuilder;
import io.runescape.net.login.LoginReturnCode;
import io.runescape.net.login.RS2LoginProtocol;
import io.runescape.net.outgoing.UnnecessaryPacketDropper;
import io.runescape.new_quest_tab.AchievementTab;
import io.runescape.new_quest_tab.EventTab;
import io.runescape.new_quest_tab.GeneralTab;
import io.runescape.new_quest_tab.PersonalTab;
import io.runescape.util.ISAACCipher;
import io.runescape.util.Misc;
import io.runescape.util.Stopwatch;
import io.runescape.util.Stream;
import io.runescape.util.discord.Discord;
import io.runescape.util.logging.player.ChangeAddressLog;
import io.runescape.util.logging.player.ConnectionLog;
...
import static io.runescape.model.entity.player.PlayerHandler.players;
...
public class Player extends Entity {
    ...
    public boolean isAggressionTimeout(Player player) {
        ...
        if (Boundary.isIn(player, Boundary.KRAKEN_BOSS_ROOM)) {
            return true;
        }
        if (Boundary.isIn(player, Boundary.KBD) || Boundary.isIn(player, Boundary.KBD_AREA)) {
            return true;
        }
    ...
    public io.runescape.content.preset.Set lastPreset;
    ...
    private final Queue<io.runescape.net.Packet> queuedPackets = new ConcurrentLinkedQueue<>();
    ...
    public int[] solakDamageCounters = new int[15];
    public int[] koraneDamageCounters = new int[15];
    public int[] revDamageCounters = new int[15];
    public int[] nexDamageCounters = new int[15];
    ...
    public int outlastKills, outlastDeaths;
    /**
    ...
    public void flushOutStream() {
        ...
        io.runescape.net.Packet packet = new io.runescape.net.Packet(-1, io.runescape.net.Packet.Type.FIXED, Unpooled.wrappedBuffer(temp));
    ...
    public void attemptLogout() {
        ...
        if (Boundary.isInAny(this, Boundary.LMS_AREAS)) {
            sendMessage("@red@You can't logout untill the game ends.");
        ...
        if (this.getPosition().inClanWars() || this.getPosition().inClanWarsSafe()) {
            sendMessage("@cr10@You can not log out in this zone use the portal to leave.");
            return;
        }

        if (Boundary.isInAny(this, Boundary.KRATOS_AREA)) {
            sendMessage("@red@You can't logout in this fight.");
            sendMessage("@red@If you force logout you will lose your items.");
            return;
        }
        if (Boundary.isInAny(this, Boundary.NEX_BOSS_ROOM)) {
            sendMessage("@red@You can't logout in the nex chamber.");
            sendMessage("@red@use the alter to teleport home.");
            return;
        }

        if (Boundary.isInAny(this, Boundary.SEA_SNAKE_DECK)) {
            sendMessage("@red@You can't logout in this fight.");
            sendMessage("@red@use the portal to teleport home.");
            return;
        }
    ...
    public void destruct() {
        ...
        if (Boundary.isInAny(this, Boundary.ROOFTOP_COURSES)) {
            getPA().movePlayer(getX(), getY(), 0);//Simple fix for the log out bug caused when logging out during course
            return;
        }

        if (this.xInterfaceId == 45500 || this.isChecking) {
    ...
    public void finishLogin() {
        ...
        if (totalLevel >= 2178) {
            ...
            io.runescape.achievements.AchievementHandler.activate(this, AchievementList.MAX, 1);
        }
        ...
        Toplist.updateToplist();//toplist
        GeneralTab.loadInformation(this);//New quest tab
    ...
    public void process() {
        ...
        if (respawnTimer == 9) {
            ...
            if (underAttackByPlayer > 0 && underAttackByPlayer < players.length && players[underAttackByPlayer] != null) {
                players[underAttackByPlayer].setInCombatDelay(Configuration.IN_COMBAT_TIMER);
            }
            // Animation
            respawnTimer--;
            startAnimation(2304);
        ...
        switch (infoTabSelected) {//For the new quest tab
            case 0:
                GeneralTab.loadInformation(this);
                break;
            case 1:
                PersonalTab.loadInformation(this);
                break;
            case 2:
                EventTab.loadInformation(this);
                break;
            case 3:
                AchievementTab.loadInformation(this);
                break;
        }
    ...
    public void processCombat() {
        ...
        if (playerAttackingIndex > 0) {
            attacking.attackEntity(players[playerAttackingIndex]);
        }
    }
    ...
    private void sendAreaInterfaces() {
        ...
        if (getPosition().inWild() && !getPosition().inClanWars()) {
            ...
            wildLevel = 126;
        } else if (getPosition().inGodwars() || Boundary.isIn(this, Boundary.NEX_AREA)) {
    ...
    public void correctCoordinates() {
        ...
        if (Boundary.isIn(new Position(teleportToX, teleportToY, heightLevel), Boundary.LMS_AREAS)) {
            setTeleportToX(3116);
            setTeleportToY(3492);
            heightLevel = 0;
        }
...
//        }
    ...
    public void assignAutocast(int button) {
        for (int j = 0; j < CombatSpellData.AUTOCAST_IDS.length; j++) {
            if (CombatSpellData.AUTOCAST_IDS[j] == button) {
                Player c = players[this.getIndex()];
                autocasting = true;
    ...
    public boolean Raiments_of_the_Eye_Set_Green() {
        return getItems().isWearingItem(26864) && getItems().isWearingItem(26866) && getItems().isWearingItem(26868) && getItems().isWearingItem(26856);
    }

    public boolean Raiments_of_the_Eye_Set_Blue() {
        return getItems().isWearingItem(26870) && getItems().isWearingItem(26872) && getItems().isWearingItem(26874) && getItems().isWearingItem(26856);
    }

    public boolean Raiments_of_the_Eye_Set_Red() {
        return getItems().isWearingItem(26858) && getItems().isWearingItem(26860) && getItems().isWearingItem(26862) && getItems().isWearingItem(26856);
    }

    public boolean fullCrystal() {
        return getItems().isWearingItem(23971) && getItems().isWearingItem(23975) && getItems().isWearingItem(23979) && getItems().isWearingItem(20999);
    }
    ...
    public boolean maxedSkiller(Player c) {
        ...
        for (int i = 18; i <= 18; i++) {//Fix for the skiller title
            if (c.playerLevel[i] >= 99) {
                amount++;
            }
        }

        for (int i = 22; i <= 22; i++) {//Fix for the skiller title
            if (c.playerLevel[i] >= 99) {
                amount++;
            }
        }
        ...
        for (LobbyType lobbyType : LobbyType.values()) {
            LobbyManager.get(lobbyType).ifPresent(lobby -> {
                if (lobby.inLobby(this)) {
                    ...
                    else getPA().movePlayerUnconditionally(1245, 3562, 0);//TODO Make this independent for all lobbies
                }
            });
        }
    ...
    public void setKoraneDamageCounter(int damage) {
        this.koraneDamageCounters[9] = damage;
    }

    public void setRevDamageCounter(int damage) {
        this.revDamageCounters[9] = damage;
    }

    public void setNexDamageCounter(int damage) {
        this.nexDamageCounters[9] = damage;
    }


    public int getSolakDamageCounter() {
        return solakDamageCounters[9];
    }

    public int getKoraneDamageCounter() {
        return koraneDamageCounters[9];
    }

    public int getRevDamageCounter() {
        return revDamageCounters[9];
    }

    public int getNexDamageCounter() {
        return nexDamageCounters[9];
    }

    public void setSolakDamageCounter(int damage) {
        this.solakDamageCounters[9] = damage;
    }
    ...
    public Questing getTabswitcher() {
        return questing;
    }
    ...
    public boolean wogw = false;

    public void checkWellOfGoodwillTimers() {
        /**
         * Well of goodwill
         */
    ...
    public LastManStanding getLastManStandingInstance() {
        return lastmanstandingInstance;
    }

    public void setLastManStandingInstance(LastManStanding lastmanstandingInstance) {
        this.lastmanstandingInstance = lastmanstandingInstance;
    }
    ...
    public void setLastManPoints(int lastManPoints) {
        this.lastManPoints = lastManPoints;
    }
    ...
    public void setLastManWins(int lastManWins) {
        this.lastManWins = lastManWins;
    }

    private RingOfKoranes.CollectionLocation ringOfKoranesCollection = RingOfKoranes.CollectionLocation.GROUND;

    public RingOfKoranes.CollectionLocation getRingOfKoranesCollection() {
        return ringOfKoranesCollection;
    }

    public void setRingOfKoranesColletion(RingOfKoranes.CollectionLocation location) {
        this.ringOfKoranesCollection = location;
    }
    ...
    private RingOfKoranesImbue.CollectionLocation ringOfKoranesImbueCollection = RingOfKoranesImbue.CollectionLocation.GROUND;

    public RingOfKoranesImbue.CollectionLocation getRingOfKoranesImbueCollection() {
        return ringOfKoranesImbueCollection;
    }

    public void setRingOfKoranesImbueColletion(RingOfKoranesImbue.CollectionLocation location) {
        this.ringOfKoranesImbueCollection = location;
    }

    public long lastDonation = System.currentTimeMillis();
    public String playerName = null;

    public int chestsOpen;
    public int keysCollected;
    public int rarekeysCollected;


    public void setChestsOpen(int chestsOpen) {
        this.chestsOpen = chestsOpen;
    }

    public int getChestsOpen() {
        return chestsOpen;
    }
    ...
    public void setRareKeysCollected(int rarekeysCollected) {
        this.rarekeysCollected = rarekeysCollected;
    }

    public int getRareKeysCollected() {
        return rarekeysCollected;
    }
    ...
    public int lotteryWins;
    public int lotteryTickets;
    public int lotteryMbox;
    ...
    public boolean payment(int amount) {
        if (isPouchPayment()) {
            if (getMoneyPouch() < amount) {
                sendMessage("You do not have enough coins in your pouch to do this!");
                return false;
            }
            ...
            getItems().deleteItem(995, amount);
            return true;
        }
    }
    ...
    public int tournamentWins, tournamentPoints, tournyKills, tournyDeaths, tournamentTotalGames;

//New system for achievements

    private HashMap<AchievementList, Integer> playerAchievements = new HashMap<>(AchievementList.values().length) {
        {
    ...
    public static Player getPlayerByName(String username) {
        ...
        for (Player p : players) {
            if ((p != null) && (p.isActive) && (p.nameAsLong == n)) {
                return p;
            }
        }
    ...
    public int[] priceItem = new int[28];
    ...
    public boolean getDropRateBonus() {//Used for 10% droprate perk
        return dropRate10;
    }
    ...
    public boolean getCrystalKeyPerk() {//Used for Crystal keys perk
        return crystalKeyPerk;
    }
    ...
    public boolean getRangeStrengthPerk() {//Used for Range strength perk
        return rangeStrengthPerk;
    }
    ...
    public boolean getHalfHitPerk() {//Used for Range strength perk
        return halfHitPerk;
    }
    ...
    public boolean getDropRateBonus20() {//Used for 10% droprate perk
        return dropRate20;
    }
    ...
    public boolean getDamageTakenPerk() {//Used for 10% droprate perk
        return damageTaken;
    }
    ...
    public boolean getCoinBagPerk() {//Used for 10% droprate perk
        return coinBagPerk;
    }
    ...
    public boolean getMagicStrengthPerk() {//Used for 10% droprate perk
        return magicStrenghPerk;
    }
    ...
    public boolean getResourceBoxPerk() {//Used for 10% droprate perk
        return resourceBoxPerk;
    }
    ...
    public boolean getMeleeStrengthPerk() {//Used for 10% droprate perk
        return meleeStrengthPerk;
    }
    ...
    public boolean getClueScrollPerk() {//Used for 10% droprate perk
        return clueScrollPerk;
    }
