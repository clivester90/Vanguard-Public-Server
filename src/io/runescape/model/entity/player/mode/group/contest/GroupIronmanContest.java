package io.runescape.model.entity.player.mode.group.contest;
...
import io.runescape.sql.gim.GetGimTopThreeTeamsQuery;
    ...
    public static void openInterface(Player c) {
        ...
        Server.getDatabaseManager().exec(((context, connection) -> {
            ...
            c.addQueuedAction(plr -> {
                ...
                plr.getPA().sendFrame126("Earned shards", 39913);
