...
import io.runescape.model.entity.player.mode.group.log.GimDropItemLog;
import io.runescape.model.entity.player.mode.group.log.GimWithdrawItemLog;
...
public class GroupIronmanLogsInterface {
    ...
    public static void open(Player player) {
        GroupIronmanRepository.getGroupForOnline(player).ifPresentOrElse(g -> new DialogueBuilder(player).option(
        ...
        ).send(), () -> player.sendMessage("You're not in a Group Ironman group."));
    }
