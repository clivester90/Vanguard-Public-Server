		...
		if (BryophytaStaff.handleItemOption(c, itemId, 2))
			...
			switch (itemId) {
				...
				case RingOfKoranesImbue.ID://Ring of koranes(i)
					c.sendMessage("<img=10> <col=996633>Your ring is now collecting items and sending them to " + c.getRingOfKoranesCollection().name().toLowerCase() + ".");
					break;
			...
			case 9786:
			case 9787:
				c.getPA().startTeleport(1352, 10258, 0, "modern", false);
				c.sendMessage("@blu@Your cape takes you to karuulm slayer dungeon.");
				break;
