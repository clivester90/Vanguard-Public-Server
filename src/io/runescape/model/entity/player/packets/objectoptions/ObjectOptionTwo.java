...
import io.runescape.content.item.lootable.impl.RaidsChestCommon;
import io.runescape.content.item.lootable.impl.RaidsChestRare;
...
public class ObjectOptionTwo {
	...
	public static void handleOption(final Player c, int objectType, int obX, int obY) {
		...
		switch (objectType) {
			...
			case 42965://Nex exit from chamber
				c.sendMessage("@red@You have teleported from nex's chamber.");
				c.getPA().movePlayer(3102, 3510, 0);
				break;

			case 6097://Donate seeds to well
				Hespori.clickObject(c, c.objectId);
				break;


			case 635://tea stall varrock
				c.facePosition(object.getX(), object.getY());
