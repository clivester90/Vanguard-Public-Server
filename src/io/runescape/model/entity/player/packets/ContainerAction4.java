...
import io.runescape.content.tradingpost.Sale;
...
public class ContainerAction4 implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		case 45542://with draw all from the price checker
			PriceChecker.withdrawItem(c, removeId, removeSlot, c.priceItemN[removeSlot]);
			break;
		...
		case 5064:
			...
			if (c.isChecking) {
				PriceChecker.depositItem(c, removeId, c.playerItemsN[removeSlot]);
			}
