...
import io.runescape.content.hs.LotteryHighscore;
...
import io.runescape.content.skills.slayer.SlayerRewardsInterfaceData;
...
public class NpcOptionFour {
	...
	public static void handleOption(Player player, int npcType) {
		...
		case 1017://Lottery
			player.setHighscore(new LotteryHighscore());
			player.getHighscore().process();
			player.getHighscore().generateList(player);
		    break;
