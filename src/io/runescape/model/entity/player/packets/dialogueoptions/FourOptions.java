...
import io.runescape.content.bosses.CommanderZilyanaInstance;
import io.runescape.content.bosses.GeneralGraadorInstance;
import io.runescape.content.bosses.KreeArraInstance;
import io.runescape.content.bosses.KrilTsutsarothInstance;
...
public class FourOptions {
	...
	public static void handleOption1(Player c) {
		...
		switch (c.dialogueAction) {
			...
			// Lottery npc
			case 1596:
				Lottery.howDoesTheLotteryWorkDialogueOption(c);
				break;


			// godwars instance
			case 5751:// kril Tsutsaroth
				if (c.getItems().playerHasItem(995, 6000000)) {
					c.getItems().deleteItem(995, 6000000);
					KrilTsutsarothInstance.startKrilInstance(c);
					c.sendMessage("@red@Use the portal to spawn the mechanics.");
					c.getPA().closeAllWindows();
				} else {
					c.getDH().sendStatement("You need to pay 6m coins to enter.");
				}
				break;
	...
	public static void handleOption2(Player c) {
		switch (c.dialogueAction) {
			...
			// Lottery npc
			case 1596:
				Lottery.buyLotteryTicketsDialogueOption(c);
				break;



			// godwars instance
			case 5751:// commander zilyana
				if (c.getItems().playerHasItem(995, 6000000)) {
					c.getItems().deleteItem(995, 6000000);
					CommanderZilyanaInstance.startCommanderZilyanaInstance(c);
					c.sendMessage("@red@Use the portal to spawn the mechanics.");
					c.getPA().closeAllWindows();
				} else {
					c.getDH().sendStatement("You need to pay 6m coins to enter.");
	...
	public static void handleOption3(Player c) {
		switch (c.dialogueAction) {
			...
			// Lottery npc
			case 1596:
				Lottery.currentPotAtDialogueOption(c);
				break;

			// godwars instance
			case 5751:// general graador
				if (c.getItems().playerHasItem(995, 7000000)) {
					c.getItems().deleteItem(995, 7000000);
					GeneralGraadorInstance.startGeneralGraadorInstance(c);
					c.sendMessage("@red@Use the portal to spawn the mechanics.");
					c.getPA().closeAllWindows();
				} else {
					c.getDH().sendStatement("You need to pay 7m coins to enter.");
				}
				break;
	...
	public static void handleOption4(Player c) {
		switch (c.dialogueAction) {
			...
			// Lottery npc
			case 1596:
				Lottery.percentageOfWinningDialogueOption(c);
				break;
			...
			case 5751:// kree arra
				if (c.getItems().playerHasItem(995, 7000000)) {
					c.getItems().deleteItem(995, 7000000);
					KreeArraInstance.startKreeArraInstance(c);
					c.sendMessage("@red@Use the portal to spawn the mechanics.");
					c.getPA().closeAllWindows();
				} else {
					c.getDH().sendStatement("You need to pay 7m coins to enter.");
