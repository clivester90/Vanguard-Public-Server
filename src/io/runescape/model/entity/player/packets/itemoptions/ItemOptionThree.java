...
import io.runescape.content.dialogue.impl.AmethystChiselDialogue;
...
public class ItemOptionThree implements PacketType {
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        switch (itemId) {
            ...
            case 23073://Hydra slayer helm
                if (!c.getItems().playerHasItem(23073)) {
                ...
                c.sendMessage("@blu@You have dismantled your slayer helmet.");
                c.getItems().deleteItem(23073, 1);//hydra slayer helm
                c.getItems().addItem(23077, 1);//alchemical hydra heads
                c.getItems().addItem(11864, 1);//normal slayer helm
                break;

            case 23075://Hydra slayer helm i
                if (!c.getItems().playerHasItem(23075)) {
                    c.sendMessage("@blu@You do not have the item to do this.");
                    return;
                }
                if (c.getItems().freeSlots() < 2) {
                ...
                c.sendMessage("@blu@You have dismantled your slayer helmet.");
                c.getItems().deleteItem(23075, 1);//hydra slayer helm i
                c.getItems().addItem(23077, 1);//alchemical hydra heads
                c.getItems().addItem(11865, 1);//normal slayer helm i
                break;



            case 30129://Bank feature for arks pet
                c.sendMessage("@red@If you want this feature let me know ark.");
                break;
            ...
            case RingOfKoranesImbue.ID://Ring of koranes
                RingOfKoranesImbue.toggleConfig(c);
                break;

            case RingOfKoranes.ID://Ring of koranes
                RingOfKoranes.toggleConfig(c);
                break;
            ...
            case 24370://Twisted slayer helm
            case 24444:
            case 19639:
            case 19641:
            case 19643:
