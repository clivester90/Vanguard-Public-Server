...
import io.runescape.content.DiceHandler;
import io.runescape.content.FishingCasket;
import io.runescape.content.RuneCraftingCasket;
import io.runescape.content.Tomes;
import io.runescape.content.barrows.Barrows;
import io.runescape.content.bosses.Cerberus;
import io.runescape.content.bosses.mimic.MimicCasket;
...
import io.runescape.content.dialogue.impl.ClaimDonatorScrollDialogue;
import io.runescape.content.dwarfmulticannon.Cannon;
import io.runescape.content.item.lootable.impl.*;
import io.runescape.content.items.CluescrollRateIncreaseScroll;
import io.runescape.content.items.Lamps;
import io.runescape.content.items.Packs;
...
import io.runescape.content.skills.DoubleExpScroll;
import io.runescape.content.skills.SkillHandler;
import io.runescape.content.skills.SkillPetRateIncreaseScroll;
import io.runescape.content.skills.hunter.Hunter;
import io.runescape.content.skills.hunter.trap.impl.BirdSnare;
import io.runescape.content.skills.hunter.trap.impl.BoxTrap;
...
import io.runescape.model.multiplayersession.flowerpoker.FlowerData;
import io.runescape.model.world.objects.GlobalObject;
import io.runescape.util.Misc;
import io.runescape.util.discord.Discord;

import static io.runescape.content.DiceHandler.DICING_AREA;
...
public class ItemOptionOne implements PacketType {
    ...
    public final static double SKILL_PET_CHANCE = 3;//sKILLING BONUS PET CHANCE
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        if (Tomes.openSet(c, itemId)) {//Tomes
            return;
        }
        ...
        switch (itemId) {
            ...
            case 25590://runecrating casket
                RuneCraftingCasket.openRuneCraftingCasket(c);
                break;

            case 7956://fishing casket
                FishingCasket.openFishingCasket(c);
                break;

            case 4447://antique lamp
                if (!c.getItems().playerHasItem(4447)) {
                    c.sendMessage("You need an Antique lamp to do this!");
                    return;
                }
                if (!Misc.hasOneOutOf(SKILL_PET_CHANCE)) {
                    c.sendMessage("@red@You was not rewarded, better luck next time.");
            ...
            case 8152://vote boss chest
                c.getDH().sendDialogues(5678, 9011);
                break;


            case 21307://Wildy Crate
        ...
        case 6830:   
            ...
            case 299:
               ...
               plantMithrilSeed(c);
          //      c.sendMessage("@red@Currently under development check back soon.");
                break;
            ...
            case 13190:
                if (c.getItems().playerHasItem(13190, 1)) {
                    ...
                    c.getInventory().addAnywhere(new ImmutableItem(2841, 2));//double exp scroll
                    c.getInventory().addAnywhere(new ImmutableItem(995, 500000));//coins
                    c.getInventory().addAnywhere(new ImmutableItem(2437, 10)); // Super Attack (4)
                    c.getInventory().addAnywhere(new ImmutableItem(2441, 10)); // Super Strength (4)
                    ...
                    c.getInventory().addAnywhere(new ImmutableItem(386, 150));//noted shark
                ...
                break;
            case 6466:
                ShatteredShardPrice.openExchangeRateShop(c);
                break;
            case 13346:
            ...
            case 8167:
                ...
                break;
            case 12789:
                new YoutubeMysteryBox(c).quickOpen();
                break;
