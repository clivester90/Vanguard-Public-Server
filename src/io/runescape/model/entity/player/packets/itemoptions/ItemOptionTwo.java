...
import io.runescape.content.displayname.ChangeDisplayName;
import io.runescape.content.item.lootable.LootableInterface;
import io.runescape.content.items.*;
...
import io.runescape.content.skills.hunter.impling.Impling;
import io.runescape.content.skills.runecrafting.Pouches;
...
public class ItemOptionTwo implements PacketType {
	...
	public void processPacket(Player player, int packetType, int packetSize) {
		...
		switch (itemId) {
			...
			case 26992://amulet of the eye green
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26992, 1);//aumet of the eye green
				player.getItems().addItem(26807, 1);//abyssal green dye
				player.getItems().addItem(26914, 1);//amulet of the eye
				player.sendMessage("@blu@You revert the amulet of the eye(green).");
				break;

			case 26994://amulet of the eye blue
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26994, 1);//aumet of the eye blue
				player.getItems().addItem(26809, 1);//abyssal blue dye
				player.getItems().addItem(26914, 1);//amulet of the eye
				player.sendMessage("@blu@You revert the amulet of the eye(blue).");
				break;

			case 26990://amulet of the eye red
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26990, 1);//aumet of the eye red
				player.getItems().addItem(26811, 1);//abyssal red dye
				player.getItems().addItem(26914, 1);//amulet of the eye
				player.sendMessage("@blu@You revert the amulet of the eye(red).");
				break;

			case 26868://robe bottoms of the eye green
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26868, 1);//robe bottoms of the eye green
				player.getItems().addItem(26807, 1);//abyssal green dye
				player.getItems().addItem(26854, 1);//robe bottom of the eye
				player.sendMessage("@blu@You revert the robe bottoms of the eye(green).");
				break;

			case 26874://robe bottoms of the eye blue
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26874, 1);//robe bottoms of the eye blue
				player.getItems().addItem(26809, 1);//abyssal blue dye
				player.getItems().addItem(26854, 1);//robe bottom of the eye
				player.sendMessage("@blu@You revert the robe bottoms of the eye(blue).");
				break;

			case 26862://robe bottoms of the eye red
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26862, 1);//robe bottoms of the eye red
				player.getItems().addItem(26811, 1);//abyssal red dye
				player.getItems().addItem(26854, 1);//robe bottom of the eye
				player.sendMessage("@blu@You revert the robe bottoms of the eye(red).");
				break;

			case 26866://robe top of the eye green
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26866, 1);//robe top of the eye green
				player.getItems().addItem(26807, 1);//abyssal green dye
				player.getItems().addItem(26852, 1);//robe top of the eye
				player.sendMessage("@blu@You revert the robe top of the eye(green).");
				break;

			case 26872://robe top of the eye blue
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26872, 1);//robe top of the eye blue
				player.getItems().addItem(26809, 1);//abyssal blue dye
				player.getItems().addItem(26852, 1);//robe top of the eye
				player.sendMessage("@blu@You revert the robe top of the eye(blue).");
				break;

			case 26860://robe top of the eye red
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26860, 1);//robe top of the eye red
				player.getItems().addItem(26811, 1);//abyssal red dye
				player.getItems().addItem(26852, 1);//robe top of the eye
				player.sendMessage("@blu@You revert the robe top of the eye(red).");
				break;

			case 26864://hat of the eye green
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26864, 1);//hat of the eye green
				player.getItems().addItem(26807, 1);//abyssal green dye
				player.getItems().addItem(26850, 1);//hat of the eye
				player.sendMessage("@blu@You revert the hat of the eye(green).");
				break;

			case 26870://hat of the eye blue
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26870 , 1);//hat of the eye blue
				player.getItems().addItem(26809, 1);//abyssal blue dye
				player.getItems().addItem(26850, 1);//hat of the eye
				player.sendMessage("@blu@You revert the hat of the eye(blue).");
				break;

			case 26858://hat of the eye red
				if (player.getItems().freeSlots() < 2) {
					player.sendMessage("You need at least two free slots to do this.");
					return;
				}
				player.getItems().deleteItem(26858 , 1);//hat of the eye red
				player.getItems().addItem(26811, 1);//abyssal red dye
				player.getItems().addItem(26850, 1);//hat of the eye
				player.sendMessage("@blu@You revert the hat of the eye(red).");
				break;
			...
			case 13204://Platinum token
				...
				player.getItems().deleteItem(13204, 1);
				player.getItems().addItemToBankOrDrop(995, 1000000000);
				player.sendMessage("@blu@You consume the token for some gold coins.");
				break;

			case 11180://Ancient coin
				player.getDH().sendDialogues(6798,-1);
				break;

			case 681://Ancient talisman
				player.getDH().sendDialogues(6700,-1);
				break;

			case RingOfKoranesImbue.ID:// Ring of koranes(i)
				RingOfKoranesImbue.sendConfig(player);
				break;

			case RingOfKoranes.ID:// Ring of koranes
				RingOfKoranes.sendConfig(player);
				break;
		...
		case 21816:
		 if (player.getItems().freeSlots() < 2) {
			 player.sendMessage("You need at least two free slots to use this.");
             return;
         }
