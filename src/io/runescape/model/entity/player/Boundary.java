...
public class Boundary {
	...
	public static final Boundary FLOWER_POKER_AREA = new Boundary(3107, 3485, 3114, 3498);
	public static final Boundary FP_LANE_1 = new Boundary(3108, 3487, 3112, 3488);
	public static final Boundary FP_LANE_2 = new Boundary(3108, 3490, 3112, 3491);
	public static final Boundary FP_LANE_3 = new Boundary(3108, 3493, 3112, 3494);
	public static final Boundary FP_LANE_4 = new Boundary(3108, 3496, 3112, 3497);
...
//3082 3921
	...
	public static final Boundary WILDY_SLAYER_CAVE = new Boundary(3328, 10048, 3391, 10175);
	public static final Boundary WILDY_SLAYER_CAVE_2 = new Boundary(3390, 10052, 3454, 10175);
	...
	public static final Boundary HUNTER_LZ_DONATOR = new Boundary(1947, 2730, 1961, 2736);
	public static final Boundary[] HUNTER_BOUNDARIES = {HUNTER_JUNGLE, HUNTER_WILDERNESS, HUNTER_LOVAK, HUNTER_LZ_DONATOR};
	...
	public static final Boundary[] WILDERNESS_PARAMETERS = {WILDERNESS, WILDERNESS_UNDERGROUND, WILDERNESS_GOD_WARS_BOUNDARY, REV_CAVE, WILDY_SLAYER_CAVE_2};
	public static final Boundary[] DEEP_WILDY_CAVES = {WILDERNESS_UNDERGROUND, WILDERNESS_GOD_WARS_BOUNDARY, REV_CAVE, WILDY_SLAYER_CAVE_2};
...
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary ARDOUGNE_MASTER = new Boundary(3044, 3300, 3062, 3312);
	...
	public static final Boundary VOTE_BOSS_ROOM = new Boundary(2438, 5013, 2474, 5053);
	...
	//South Side
	public static final Boundary RAIDS_LOBBY = new Boundary(3020, 6035, 3049, 6062); //old lobby
	//public static final Boundary RAIDS_LOBBY = new Boundary(1228, 3553, 1239, 3564); // new lobby
	//public static final Boundary RAIDS_LOBBY_ENTRANCE = new Boundary(3027, 6065, 3040, 6072); // old entrance for party system
	public static final Boundary RAIDS_LOBBY_ENTRANCE = new Boundary(1225, 3534, 1248, 3573);//New entrance for party system
	...
	//Event Boss Spawns
	public static final Boundary Level_54_WILD = new Boundary(3285, 3862, 3337, 3907);
	public static final Boundary[] EVENT_AREAS = { Level_54_WILD};

	public static final Boundary SOLAK_AREA = new Boundary(1697, 3864, 1740, 3903);

	public static final Boundary GALVEK_AREA = new Boundary(2969, 3929, 2992, 3967);

	public static final Boundary SEREN_AREA = new Boundary(3178, 3872, 3212, 3899);//Change this if ever move seren to an diff location

	public static final Boundary TARN_AREA = new Boundary(3181, 4612, 3191, 4626);
	public static final Boundary KRATOS_AREA = new Boundary(3008, 5218, 3039, 5246);

	public static final Boundary DEATH_NPC_AREA = new Boundary(3083, 3514, 3085, 3515);//Change this when change home


	public static final Boundary AFK_ZONE = new Boundary(3072, 3456, 3084, 3464);//Change this when home changed

	public static final Boundary LMS_LOBBY = new Boundary(3117, 3489, 3119, 3495);//CHANGE THIS WHEN CHANGE THE HOME
	public static final Boundary LMS_ARENA = new Boundary(3121, 3489, 3128, 3495);//CHANGE THIS WHEN CHANGE THE HOME
	public static final Boundary[] LMS_AREAS = { LMS_LOBBY, LMS_ARENA };


	public static final Boundary DONATOR_ZONE = new Boundary(2127, 2678, 2156, 2748);
	public static final Boundary DONATOR_ZONE_BOSS = new Boundary(2143, 2702, 2176, 2711);
	public static final Boundary REGULAR_DZ_HUNTER = new Boundary(2128, 2693, 2130, 2706);

	public static final Boundary KORANIAN_AREA = new Boundary(3297, 3923, 3315, 3948);//Nightmare event

	public static final Boundary REV_MALEDICTUS_AREA = new Boundary(3119, 3819, 3151, 3852);//Enranged maledictus event

	public static final Boundary BONFIRE_AREA = new Boundary(3079, 3462, 3082, 3465);//CHANGE THIS WHEN CHANGE THE HOME
	public static final Boundary AFK_FURNACE_AREA = new Boundary(3079, 3467, 3081, 3471);//CHANGE THIS WHEN CHANGE THE HOME
	public static final Boundary AFK_COOKING_AREA = new Boundary(3093, 3463, 3094, 3465);//CHANGE THIS WHEN CHANGE THE HOME

	public static final Boundary NEW_CORP_BOUNDARY = new Boundary(2976, 4398, 3000, 4366);
	...
	public static final Boundary NEX_AREA = new Boundary(2860, 5174, 2949, 5224);
	public static final Boundary NEX_BOSS_ROOM = new Boundary(2910, 5187, 2989, 5217);
	public static final Boundary NEX_JUMP_ATTACK = new Boundary(2923, 5190, 2926, 5206);

	public static final Boundary NEX_REAVER_ROOM = new Boundary(2853, 5198, 2898, 5234);

	public static final Boundary TOURNY_COMBAT_AREA = new Boundary(3275, 4760, 3375, 4847);//TOURNAMENTS

	public static final Boundary DUMMIES = new Boundary(3104, 3509, 3105, 3511);//DUMMIES AT HOME

	public static final Boundary EDGE = new Boundary(3027, 3456, 3105, 3519);

	public static final Boundary SEA_SNAKE_DECK = new Boundary(1647, 5902, 1705, 5933);

	public static final Boundary SEA_SNAKE_OUTSIDE_DECK = new Boundary(1646, 5922, 1700, 5929);
	public static final Boundary SEA_SNAKE_OUTSIDE_DECK2 = new Boundary(1637, 5909, 1702, 5917);
	...
	public static boolean inCorpBossRoom(Player player) {
		return isWithInArea(player, 2976, 4366, 3000, 4398);
	}
