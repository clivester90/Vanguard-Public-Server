...
import io.runescape.content.achievement.AchievementTier;
import io.runescape.content.achievement_diary.DifficultyAchievementDiary;
import io.runescape.content.achievement_diary.impl.ArdougneDiaryEntry;
import io.runescape.content.achievement_diary.impl.DesertDiaryEntry;
import io.runescape.content.achievement_diary.impl.FaladorDiaryEntry;
import io.runescape.content.achievement_diary.impl.FremennikDiaryEntry;
import io.runescape.content.achievement_diary.impl.KandarinDiaryEntry;
import io.runescape.content.achievement_diary.impl.KaramjaDiaryEntry;
import io.runescape.content.achievement_diary.impl.LumbridgeDraynorDiaryEntry;
import io.runescape.content.achievement_diary.impl.MorytaniaDiaryEntry;
import io.runescape.content.achievement_diary.impl.VarrockDiaryEntry;
import io.runescape.content.achievement_diary.impl.WesternDiaryEntry;
import io.runescape.content.achievement_diary.impl.WildernessDiaryEntry;
...
import io.runescape.content.event.eventcalendar.EventChallengeKey;
...
import io.runescape.content.privatemessaging.FriendType;
import io.runescape.content.privatemessaging.FriendsListEntry;
import io.runescape.content.skills.slayer.SlayerMaster;
import io.runescape.content.skills.slayer.SlayerUnlock;
import io.runescape.content.skills.slayer.Task;
import io.runescape.content.skills.slayer.TaskExtension;
import io.runescape.content.titles.Title;
...
import io.runescape.util.PasswordHashing;
     ...
     */
                    ...
                    if (spot > -1) {
                        ...
                        switch (ReadMode) {
                            ...
                            case 2:
                                if (token.equals("character-height")) {
                                ...
                                } else if (token.equals("triviaPoints")) {
                                    p.setTriviaPoints(Integer.parseInt(token2));

                                } else if (token.equals("achievementPoints")) {//New achievements keep
                                    p.addAchievementPoints(Integer.parseInt(token2));


                                } else if (token.equals("moneyPouch")) {
                                    //p.setMoneyPouch(Integer.parseInt(token2));
                                    p.setMoneyPouch(Long.parseLong(token2));
                                } else if (token.equals("dailyTaskPoints")) {
                                    p.dailyTaskPoints = Integer.parseInt(token2);

                                } else if (token.equals("Likes")) {
                                    p.setLikes(Integer.parseInt(token2));

                                } else if (token.equals("LastLike")) {
                                    p.setLastLike(Long.parseLong(token2));

                                } else if (token.equals("LikesGiven")) {
                                    p.setLikesGiven((byte) Integer.parseInt(token2));

                                } else if (token.equals("ProfileViews")) {
                                    p.setProfileViews(Integer.parseInt(token2));

                                } else if (token.equals("Dislikes")) {
                                    p.setDislikes(Integer.parseInt(token2));


                                } else if (token.equals("RingofVanguard")) {
                                    p.setRingOfKoranesColletion(RingOfKoranes.CollectionLocation.valueOf(token2));

                                } else if (token.equals("RingofVanguardImbue")) {
                                    p.setRingOfKoranesImbueColletion(RingOfKoranesImbue.CollectionLocation.valueOf(token2));


                                } else if (token.equals("dailyTaskAmount")) {
                                    p.dailyTaskAmount = Integer.parseInt(token2);
                                } else if (token.equals("dailyTaskMultiplier")) {
                                    p.dailyTaskMultiplier = Integer.parseInt(token2);
                                ...
                                } else if (token.equals("currentDailyTask")) {
                                    if (token2 != null && !token2.isEmpty())
                                        p.currentDailyTask = DailyTasks.PossibleTasks.valueOf(token2); //Integer.parseInt(token2);
                                    ...
                                    p.setBarrowsRunCompleted(Integer.parseInt(token2));

                                } else if (token.equals("barrowsPersonalRecord")) {
                                    p.barrowsPersonalRecord = Integer.parseInt(token2);

                                } else if (token.equals("LastManPoints")) {
                                    p.setLastManPoints(Integer.parseInt(token2));
                                } else if (token.equals("LastManWins")) {
                                    p.setLastManWins(Integer.parseInt(token2));

                                } else if (token.equals("afk-points")) {
                                    p.afkPoints = Integer.parseInt(token2);

                                } else if (token.equals("loyalty-reward")) {
                                    p.loyaltyChestClaimable = Boolean.parseBoolean(token2);
                                ...
                                } else if (token.equals("keysCollected")) {
                                    p.setKeysCollected(Integer.parseInt(token2));

                                } else if (token.equals("donationWell")) {
                                    p.setDonationWell(Integer.parseInt(token2));

                                } else if (token.equals("donationSeed")) {
                                    p.setDonationSeed(Integer.parseInt(token2));

                                } else if (token.equals("lotteryWins")) {
                                    p.setLotteryWins(Integer.parseInt(token2));
                                } else if (token.equals("lotteryTickets")) {
                                    p.setLotteryTickets(Integer.parseInt(token2));
                                } else if (token.equals("lotteryMbox")) {
                                    p.setLotteryMbox(Integer.parseInt(token2));


                                } else if (token.equals("rarekeysCollected")) {
                                    p.setRareKeysCollected(Integer.parseInt(token2));
                                } else if (token.equals("chestsOpen")) {
                                    p.setChestsOpen(Integer.parseInt(token2));
                                ...
                                } else if (token.equals("nexKills")) {
                                    p.nexKills = (Integer.parseInt(token2));
                                } else if (token.equals("nexDeaths")) {
                                    p.nexDeaths = (Integer.parseInt(token2));
                                ...
                                } else if (token.equals("tournyKills")) {
                                    p.tournyKills = Integer.parseInt(token2);

                                } else if (token.equals("tournyDeaths")) {
                                    p.tournyDeaths = Integer.parseInt(token2);
                            ...
                            case 96://For the new achievments system
                                if (token != null && token.length() > 0) {
                                    p.getPlayerAchievements().put(AchievementList.valueOf(token), Integer.parseInt(token2));
                                }
                                break;
                        ...
                        } else if (line.equals("[ACHIEVEMENTSNEW]")) {//For the new achievments system
                            ReadMode = 96;
        ...
        public static boolean saveGameInstant(Player p) {
            ...
            try {
                ...
                characterfile.newLine();
                characterfile.write("chestsOpen = " + p.getChestsOpen());
                characterfile.newLine();
                characterfile.write("loyalty-reward = " + p.loyaltyChestClaimable);
                characterfile.newLine();
                characterfile.write("dailyTaskAmount = " + p.dailyTaskAmount);
                characterfile.newLine();
                characterfile.write("dailyTaskPoints = " + p.dailyTaskPoints);
                characterfile.newLine();
                characterfile.write("RingofVanguard = " + p.getRingOfKoranesCollection());
                characterfile.newLine();
                characterfile.write("RingofVanguardImbue = " + p.getRingOfKoranesImbueCollection());
                characterfile.newLine();
                characterfile.write("dailyTaskMultiplier = " + p.dailyTaskMultiplier);
                characterfile.newLine();
                characterfile.write("dailyTaskDate = " + p.dailyTaskDate);
                characterfile.newLine();
                characterfile.write("Likes = " + p.getLikes());
                characterfile.newLine();
                characterfile.write("Dislikes = " + p.getDislikes());
                characterfile.newLine();
                characterfile.write("LastLike = " + p.getLastLike());
                characterfile.newLine();
                characterfile.write("LikesGiven = " + p.getLikesGiven());
                characterfile.newLine();
                characterfile.write("ProfileViews = " + p.getProfileViews());
                characterfile.newLine();
                characterfile.write("dailyResetDate = " + p.dailyResetDate);
                characterfile.newLine();
                characterfile.write("totalDailyDone = " + p.totalDailyDone);
                characterfile.newLine();
                characterfile.write("currentDailyTask = ", 0, 19);
                if (p.currentDailyTask != null)
                    characterfile.write(p.currentDailyTask.name(), 0, p.currentDailyTask.name().length());
                characterfile.newLine();
                ...
                characterfile.newLine();
                characterfile.write("lotteryWins = " + p.getLotteryWins());
                characterfile.newLine();
                characterfile.write("lotteryTickets = " + p.getLotteryTickets());
                characterfile.newLine();
                characterfile.write("lotteryMbox = " + p.getLotteryMbox());
                characterfile.newLine();
                characterfile.write("donationWell = " + p.getDonationWell());
                characterfile.newLine();
                characterfile.write("donationSeed = " + p.getDonationSeed());
                characterfile.newLine();
                characterfile.write("keysCollected = " + p.getKeysCollected());
                characterfile.newLine();
                characterfile.write("rarekeysCollected = " + p.getRareKeysCollected());
                characterfile.newLine();
                characterfile.write("raidCount = " + p.raidCount);
                characterfile.newLine();
                characterfile.write("seaSnakeKills = " + p.seaSnakeKills);
                characterfile.newLine();
                characterfile.write("nexKills = " + p.nexKills);
                characterfile.newLine();
                characterfile.write("nexDeaths = " + p.nexDeaths);
                characterfile.newLine();
                ...
                characterfile.write("triviaPoints = " + p.getTriviaPoints());
                characterfile.newLine();

                characterfile.write("moneyPouch = " + p.getMoneyPouch());
                characterfile.newLine();

                characterfile.write("achievementPoints = " + p.getAchievementsPoints());
                characterfile.newLine();


                characterfile.write("barrowsRunCompleted = " + p.getBarrowsRunCompleted());
                characterfile.newLine();

                characterfile.write("barrowsPersonalRecord = " + p.barrowsPersonalRecord);
                characterfile.newLine();

                characterfile.write("LastManPoints = " + p.getLastManPoints());
                characterfile.newLine();

                characterfile.write("LastManWins = " + p.getLastManWins());
                characterfile.newLine();

                characterfile.write("afk-points = ", 0, 13);
                characterfile.write(Integer.toString(p.afkPoints), 0, Integer.toString(p.afkPoints).length());
                ...
                characterfile.write("tournyKills = " + p.tournyKills);
                characterfile.newLine();

                characterfile.write("tournyDeaths = " + p.tournyDeaths);
                characterfile.newLine();
                ...
                characterfile.newLine();
                characterfile.write("[ACHIEVEMENTSNEW]");//For the new achievments system
                characterfile.newLine();
                for (Entry<AchievementList, Integer> list : p.getPlayerAchievements().entrySet()) {
                    if (list != null) {
                        if (list.getValue() > 0) {
                            characterfile.write(list.getKey() + " = " + list.getValue());
                            characterfile.newLine();
                        }
                    }
                }
