...
import io.runescape.model.collisionmap.Tile;
...
public final class Position {
	...
	public boolean inWild() {
		...
		if (Boundary.isIn(this, Boundary.WILDERNESS_UNDERGROUND))
			return true;
		if (Boundary.isIn(this, Boundary.LMS_ARENA))
			return true;

		if (Boundary.isIn(this, Boundary.TOURNY_COMBAT_AREA))
			return true;
	...
	public boolean inMulti() {
		if (Boundary.isIn(this, Boundary.ZULRAH)
				...
				|| Boundary.isIn(this, Boundary.SOLAK_AREA)
				|| Boundary.isIn(this, Boundary.LMS_ARENA)
				|| Boundary.isIn(this, Boundary.CRYSTAL_CAVE_AREA)
				|| Boundary.isIn(this, Boundary.DONATOR_ZONE_BOSS)
				|| Boundary.isIn(this, Boundary.GALVEK_AREA)
				|| Boundary.isIn(this, Boundary.VORKATH)
				|| Boundary.isIn(this, Boundary.KRATOS_AREA)
				|| Boundary.isIn(this, Boundary.NEX_BOSS_ROOM)//Nex zones
				|| Boundary.isIn(this, Boundary.NEX_REAVER_ROOM)//Nex zones
				|| Boundary.isIn(this, Boundary.DUMMIES)//dummies home area
				|| Boundary.isIn(this, Boundary.WILDY_SLAYER_CAVE)//Wilderness slayer cave
				|| Boundary.isIn(this, Boundary.WILDY_SLAYER_CAVE_2)//Wilderness slayer cave
				|| Boundary.isIn(this, Boundary.REV_MALEDICTUS_AREA)//Enranged maledictus zone
				|| Boundary.isIn(this, Boundary.SEA_SNAKE_DECK)//Powerful sea snake boss
		) {
			return true;
		}
