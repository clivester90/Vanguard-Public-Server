package io.runescape.model.entity;
...
import io.runescape.content.minigames.xeric.Xeric;
...
import static io.runescape.model.entity.npc.NPCClipping.DIR;
...
public abstract class Entity {
    ...
    public void startGraphicTest(Graphic graphic,Position position) {
        if (this.graphic == null || graphic.getAnimationPriority().compareTo(this.graphic.getAnimationPriority()) >= 0) {
            this.graphic = graphic;
            setUpdateRequired(true);
            gfxUpdateRequired = true;
