            ...
            if (policy.equals(TablePolicy.CONSTANT)) {
                ...
                for (int i = 0; i < repeats; i++) {
                    ...
                    if (roll <= chance) {
                        ...
                        if (itemNameLowerCase.contains("archer ring") || itemNameLowerCase.contains("vasa minirio") || itemNameLowerCase.contains("treasonous ring")
                                || itemNameLowerCase.contains("tyrannical ring") || itemNameLowerCase.contains("tektiny") || itemNameLowerCase.contains("death cape")
                             //   || itemNameLowerCase.contains("black mask")
                        ...
                        if (policy.equals(TablePolicy.VERY_RARE) || policy.equals(TablePolicy.RARE)) {
                            ...
                            if (
                                    ...
                                    || name.contains("bones")
                                            ...
                                            || npc.getNpcId() == 1377// NEW DONATION BOSS FOR ARK DO NOT ANNOUNCE DROPS
