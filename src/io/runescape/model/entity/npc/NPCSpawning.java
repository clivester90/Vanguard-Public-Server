...
public class NPCSpawning {
     ...
     * Summon barrows
     */
    public static NPC spawnBarrows(Player c, int npcType, int x, int y, int heightLevel, boolean attackPlayer,
                                   boolean headIcon, int maxHit) {
        // first, search for a free slot

        if (NpcDef.getDefinitions() == null) {
            Misc.print("Npc is null: (add the definitions) " + npcType);
            return null;
        }
