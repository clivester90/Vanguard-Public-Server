package io.runescape.model.entity.npc.data;
...
public class AttackAnimation extends NPCHandler {
	...
	public static int handleEmote(NPC npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 6299://donation regular boss
				if (npc.getAttackType() == CombatType.RANGE) {
					return 128;
				} else if (npc.getAttackType() == CombatType.MAGE) {
					return 132;
		...
		case 7563://Muttadiles
			return npc.getAttackType() == CombatType.MAGE ? 7422 : npc.getAttackType() == CombatType.RANGE ? 7421 : npc.getAttackType() == CombatType.MELEE ? 7424 : 7421;
		...
		case 7573://Lizard shawman
			return npc.getAttackType() == CombatType.MAGE ? 7193 : 7192;
