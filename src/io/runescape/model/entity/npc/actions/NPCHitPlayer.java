package io.runescape.model.entity.npc.actions;
...
import io.runescape.content.bosses.Scorpia;
...
import io.runescape.content.combat.effects.damageeffect.impl.SerpentineHelmEffect;
import io.runescape.content.combat.formula.CombatFormula;
import io.runescape.content.combat.formula.MagicMaxHit;
import io.runescape.content.combat.formula.MeleeMaxHit;
import io.runescape.content.combat.formula.RangeMaxHit;
import io.runescape.content.combat.formula.rework.MagicCombatFormula;
import io.runescape.content.combat.formula.rework.MeleeCombatFormula;
...
import io.runescape.content.combat.npc.NPCAutoAttackDamage;
...
import io.runescape.model.entity.npc.stats.NpcBonus;
import io.runescape.model.entity.npc.stats.NpcCombatDefinition;
import io.runescape.model.entity.npc.stats.NpcCombatSkill;
...
public class NPCHitPlayer {
    ...
    public static CombatHit applyAutoAttackDamage(NPC npc, Player c, NPCAutoAttack npcAutoAttack) {
        ...
        if (c.getItems().isWearingItem(12931) || c.getItems().isWearingItem(13197)
                || c.getItems().isWearingItem(13199) && !(npc.getNpcId() == 319) && !(npc.getNpcId() == 3409)) {
                ...
                if (npc.getAttackType() != null) {
                    ...
                    switch (npc.getAttackType()) {
                            ...
                            if (c.protectingMelee() && !protectionIgnored) {
                                if (npc.getNpcId() == 5890)
                                    damage /= 3;
                                        ...
                                        || npc.getNpcId() == 11278//nex
                                        || npc.getNpcId() == 1101//powerful sea snake
                        ...
                        case MAGE:
                            ...
                            //PROTECTION PRAYERS FOR MAGIC
                            if (c.protectingMagic() && !protectionIgnored) {
                                if (npc.getNpcId() == 11278) {//NEX
                                    damage /= 2;
                                }
                            }
                            ...
                            if (c.protectingMagic() && !protectionIgnored) {
                                ...
                                switch (npc.getNpcId()) {
                                   ...
                                   // case 1377://DONATION BOSS NEW ARK
                                   //     damage /= 1;
                                   //     break;
                        ...
                        case SPECIAL:
                             ...
                             */
                            switch (npc.getNpcId()) {
                                case 1377://new donation boss
                                    int prayerReduction1 = c.playerLevel[5] / 2;
                                    if (prayerReduction1 < 1) {
                                        break;
                                    }
                                    c.playerLevel[5] -= prayerReduction1;
                                    if (c.playerLevel[5] < 0) {
                                        c.playerLevel[5] = 0;
                                    }
                                    c.getPA().refreshSkill(5);
                                    c.sendMessage("@red@Ark slams through your protection prayer, leaving you feeling drained.");
                                    break;
                                ...
                                case 11246://Enranged Revenant maledictus
                                    int prayerReduction5 = c.playerLevel[5] / 2;
                                    if (prayerReduction5 < 1) {
                                        break;
                                    }
                                    c.playerLevel[5] -= prayerReduction5;
                                    if (c.playerLevel[5] < 0) {
                                        c.playerLevel[5] = 0;
                                    }
                                    c.getPA().refreshSkill(5);
                                    c.freezeTimer = 5;
                                    c.sendMessage("The revenant manages to freeze you.");
                                    break;
