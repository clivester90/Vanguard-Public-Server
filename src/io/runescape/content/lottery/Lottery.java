package io.runescape.content.lottery;
...
import io.runescape.model.entity.player.DialogueHandler;
		...
		CycleEventHandler.getSingleton().addEvent(object, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				Announcement.announce(
						"<img=28><col=a36718> Lottery is at @red@" + getTotalPotString() + "<col=a36718>! Talk to the Lottery manager at ::home to enter, @red@" + getMinutesLeftTillWinner() + " min"
