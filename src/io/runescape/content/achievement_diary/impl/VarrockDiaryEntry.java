...
public enum VarrockDiaryEntry {
	...
	EARTH_RUNES("Craft some earth runes: %totalstage", 1),
	TELEPORT_ESSENCE_VAR("Have the wizard teleport you to the essence mine"),
	MINE_ESSENCE("Mine some essence: %totalstage", 10),
	TEA_STALL("Steal from the tea stall: %totalstage", 1),
	BECOME_A_DANCER("Dance, dance, dance: %totalstage", 15),
	MINE_IRON("Mine some iron ore: %totalstage", 10),
	
	//Medium
	CHAMPIONS_GUILD("Enter the champions guild: %totalstage", 1),
	DRESS_FOR_SUCESS("Browse thessalia's shop: %totalstage", 1),
	APOTHECARY_STRENGTH("Have the apothecary create you a strength potion: %totalstage", 1),
	PURCHASE_KITTEN("Buy a kitten from gertrude: %totalstage", 1),
	GRAND_TREE_TELEPORT("Use the grand tree to teleport: %totalstage", 1),
	POTION_DECANT("Let Zahur decant your potions: %totalstage", 1),
	
	//Hard
	PRAY_WITH_SMITE("Pray at the church altar with smite active: %totalstage", 1),
	OBSTACLE_PIPE("Squeeze through the pipe in edgeville dungeon: %totalstage", 1),
	...
	PRAY_WITH_PIETY("Pray at the chaos altar with piety active: %totalstage", 1);
