...
public enum Mineral {
	        ...
	        //SHOOTING_STAR(new int[] { 17196 }, "none", 60, 200, 120, -1, 26, 5000, true, generateExclusive(-1)),
			SHOOTING_STAR(new int[] { 41020 }, "none", 60, 65, -1, -1, 26, 5000, false, generateExclusive(-1)),

	        AFK_ROCK(new int[] { 2449 }, "none", 60, 1.4, -1, -1, 26, 5000000, false, generateExclusive(-1)),
