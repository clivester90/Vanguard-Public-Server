package io.runescape.content.skills.hunter;
...
import io.runescape.content.skills.hunter.trap.Trap;
import io.runescape.content.skills.hunter.trap.TrapProcessor;
import io.runescape.content.skills.hunter.trap.TrapTask;
...
public final class Hunter {
	...
	public static boolean claim(Player player, GlobalObject object) {
		...
		case 10008:
			...
			DailyTasks.increase(player, DailyTasks.PossibleTasks.RED_CHINCHOMPAS);//Daily tasks
			break;
