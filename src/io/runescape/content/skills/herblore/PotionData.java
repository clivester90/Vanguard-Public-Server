...
public class PotionData {
	...
	/**
	 * If you add new potions check out {@link io.runescape.content.skills.SkillInterfaces} if you need to
	...
	public enum FinishedPotions {
		...
		OVERLOAD(new GameItem(Items.OVERLOAD_3), 95, 7, new GameItem(Items.SUPER_COMBAT_POTION4), new GameItem(Items.TORSTOL)),
