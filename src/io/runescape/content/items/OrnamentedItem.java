...
public enum OrnamentedItem {
    ...
    HAT_OF_THE_EYE_GREEN(26850 , 26807 , 26864),
    HAT_OF_THE_EYE_BLUE(26850 , 26809 , 26870),
    HAT_OF_THE_EYE_RED(26850 , 26811 , 26858),

    ROBE_TOP_OF_THE_EYE_GREEN(26852 , 26807 , 26866),
    ROBE_TOP_OF_THE_EYE_BLUE(26852 , 26809 , 26872),
    ROBE_TOP_OF_THE_EYE_RED(26852 , 26811 , 26860),

    ROBE_BOTTOM_OF_THE_EYE_GREEN(26854 , 26807 , 26868),
    ROBE_BOTTOM_OF_THE_EYE_BLUE(26854 , 26809 , 26874),
    ROBE_BOTTOM_OF_THE_EYE_RED(26854 , 26811 , 26862),

    AMULET_OF_THE_EYE_GREEN(26914 , 26807 , 26992),
    AMULET_OF_THE_EYE_BLUE(26914 , 26809 , 26994),
    AMULET_OF_THE_EYE_RED(26914 , 26811 , 26990),
    ;
