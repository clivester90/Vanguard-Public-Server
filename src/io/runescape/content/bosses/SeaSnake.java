...
import io.runescape.content.bosses.hydra.CombatProjectile;
...
public class SeaSnake {
	...
	public static int[] rarerewards = {692, 693, 691, 24119, 2425,};//$5 scroll, 25k foe, 50k foe, 10k foe, super box, m box, black dragon hunter crossbow, Vorkath head
	static int[] veryrarerewards = {21752, 8167, 13346,};//$10 scroll, Runerogue ring, FoE Mystery Chest, ultra box
