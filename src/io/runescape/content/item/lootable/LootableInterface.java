...
public class LootableInterface {
    ...
    private static final int[] BUTTONS = {175211, 175214, 175217, 175220, 175223, 175226, 175229,
            175232, 175235, 175238, 175241, 175244, 175247, 175250, 175253, 176_000, 176_003, 176_006, 176_009, 176_012, 176_015, 176_018, 176_021, 176_024, 176_027 };

    private enum LootableView {
        VOTE_KEY(new VoteChest()),
       // UNBEARABLE_KEY(new UnbearableChest()),
        HUNLLEFS_KEY(new HunllefChest()),
        GLOD_KEY(new GlodChestItems()),
        SOLAK_KEY(new SolakChestItems()),
        ...
        KRATOS_CHEST(new KratosChestItems()),
        NIGHTMARE_CHEST(new KoranianChest()),
        SEREN_CHEST(new SerenChest()),
        LOYALTY_CHEST(new LoyaltyChestItems()),
        SLAYER_CHEST(new SlayerChestItems()),

        GALVEK_EVENT(new GalvekItems()),
        MALEDICTUS_EVENT(new MaledictusItems()),
        POWERFUL_SEA_SNAKE(new SeaSnakeItems()),
        NEX(new NexItems()),
        ;
