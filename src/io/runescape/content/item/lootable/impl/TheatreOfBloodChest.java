...
public class TheatreOfBloodChest implements Lootable {
    ...
    static {
        ...
        items.put(LootRarity.RARE, Arrays.asList(
                ...
                new GameItem(Items.AVERNIC_DEFENDER_HILT),             //RARES
                new GameItem(24780),//BLOOD FURY
                new GameItem(21752, 1), //RING OF Vanguard
                new GameItem(Items.SCYTHE_OF_VITUR),
                new GameItem(25742)//Holy sythe ornament kit.
