...
public class ReferralRegister {
    ...
    public static void register(Player player, ReferralSource source, String qualifier) {
    ...
    public static boolean canGetReward(Player player) {
    ...
    @SuppressWarnings("unchecked")
    public static HashSet<String> getUsedMapReferrals() {
