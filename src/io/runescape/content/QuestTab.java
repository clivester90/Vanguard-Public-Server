...
import io.runescape.content.achievement.inter.TasksInterface;
...
import static io.runescape.content.world_event.WorldEvent.timeEventEnd;
...
public class QuestTab {
    ...
    public void updateInformationTab() {
        ...
        player.getPA().sendFrame126("<img=20>@or1@ Daily Task Information", lines.get(index++));
