...
//        }
        ...
        if (Nex.nexMob(npc.getNpcId())) {
            // Player attacker = (Player) entity;
          //  if (!Nex.getNex(c).checkAttack(c, npc.getNpcId())) {
            if (!Nex.checkAttack(c, npc.getNpcId())) {
        ...
        if (npc.getNpcId() == 492 || npc.getNpcId() == 494) {//kraken
            if (!(c.getSlayer().getTask().isPresent()) || (c.getSlayer().getTask().isPresent() && !c.getSlayer().getTask().get().getPrimaryName().equals("kraken") && !c.getSlayer().getTask().get().getPrimaryName().equals("cave kraken"))) {
                sendCheckMessage(c, sendMessages, "You will need to active task to attack this monster.");
                return false;
            }
        }
       ...
       // }
        ...
        if (npc.getNpcId() == 5886 || npc.getNpcId() == 5890 || npc.getNpcId() == 5981 && npc.getNpcId() != 5944) {//abyssal sire
            if (!(c.getSlayer().getTask().isPresent()) || (c.getSlayer().getTask().isPresent() && !c.getSlayer().getTask().get().getPrimaryName().equals("abyssal demon")&& !c.getSlayer().getTask().get().getPrimaryName().equals("abyssal sire"))) {
                sendCheckMessage(c, sendMessages, "You need an abyssal task to attack this monster.");
                return false;
            }
