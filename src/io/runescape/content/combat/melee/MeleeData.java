...
public class MeleeData {
	...
	public static boolean usingSytheOfVitur(Player player) {
		return player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(Items.SCYTHE_OF_VITUR) || player.getItems().isWearingItem(25736);
	}
	...
	public static int getWepAnim(Player c) {
		...
		if (weaponName.contains("k'ril swords")) {
			return 0x814;
		}

		if (weaponName.contains("vorkath blowpipe")) {
			return 5061;
		}
	...
	public static int getHitDelay(Player c) {
		...
		case 26374://zarte bow
			return 4;

		case 23145://twisted crossbow
			return 4;


		case 24119://black d cb
			return 5;
