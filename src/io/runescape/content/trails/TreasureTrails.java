package io.runescape.content.trails;
	...
	private static void openCasket(Player player, RewardLevel rewardLevel) {
		...
		switch (rewardLevel) {
			case EASY:
				...
				AchievementHandler.activate(player, AchievementList.COMPLETE_25_EASY_CLUES, 1);//NEW ACHIEVEMNTS
				break;
			case MEDIUM:
				...
				AchievementHandler.activate(player, AchievementList.COMPLETE_25_NORMAL_CLUES, 1);//NEW ACHIEVEMNTS
				break;
			case HARD:
				...
				AchievementHandler.activate(player, AchievementList.COMPLETE_25_HARD_CLUES, 1);//NEW ACHIEVEMNTS
				break;
			case MASTER:
				...
				AchievementHandler.activate(player, AchievementList.COMPLETE_25_MASTER_CLUES, 1);//NEW ACHIEVEMNTS
