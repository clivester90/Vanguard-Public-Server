...
public class TriviaBot {
    ...
    public static void attemptAnswer(Player p, String attempt) {
        ...
        if (!currentQuestion.equals("") && attempt.replaceAll("_", " ").equalsIgnoreCase(currentAnswer)) {
            ...
            if (answerCount == 0) {
                answerCount++;
                if (p.getRights().isOrInherits(Right.REGULAR_DONATOR)) {
    ...
    private static final String[][] TRIVIA_DATA = {
            ...
            {"@red@ Trivia:</col> <col=6666FF>What is one commitment that will help " + Configuration.SERVER_NAME + " grow?", "vote"},
            ...
            {"@red@ Trivia:</col> <col=6666FF>Who is the owner of " + Configuration.SERVER_NAME + "?", "Grim"},
            ...
            {"@red@ Trivia:</col> <col=6666FF>What is currently the max combat level on " + Configuration.SERVER_NAME + "?", "126"},
            {"@red@ Trivia:</col> <col=6666FF>What's currently the max total level on " + Configuration.SERVER_NAME + "?", "2178"},
