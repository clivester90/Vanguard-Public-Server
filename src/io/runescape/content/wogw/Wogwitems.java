...
public class Wogwitems {
	...
	public enum itemsOnWell {
		...
		THAMMARON_SCEPTRE(22552, 7500000),
		CRAWS_BOW(22547, 15000000),
		VIGGORA_CHAINMACE(22542, 15000000),
		THIRD_AGE_RANGE_TOP(10330, 15000000),
		THIRD_AGE_RANGE_LEGS(10332, 15000000),
		THIRD_AGE_RANGE_COIF(10334, 7500000),
		THIRD_AGE_RANGE_VAMBS(10336, 5000000),
		THIRD_AGE_ROBE_TOP(10338, 10000000),
		THIRD_AGE_ROBE_BOTTOM(10340, 10000000),
		THIRD_AGE_RANGE_HAT(10342, 7500000),
		THIRD_AGE_RANGE_AMULET(10344, 5000000),
		THIRD_AGE_PLATELEGS(10346, 20000000),
		THIRD_AGE_PLATEBODY(10348, 20000000),
		THIRD_AGE_FULLHELM(10350, 15000000),
		THIRD_AGE_KITESHIELD(10352, 15000000),
		TWISTED_BUCKLER(21000, 30000000);

		private int itemId, itemWorth;

		itemsOnWell(int itemId, int itemWorth) {
			this.itemId = itemId;
