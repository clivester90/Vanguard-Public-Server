...
public class MonkeyMadnessQuest extends Quest {
    ...
    public static boolean completed = false;  // added for the new quest tab
    public static boolean started = false;  // added for the new quest tab
    ...
    public void giveQuestCompletionRewards() {
        ...
        player.getItems().addItemUnderAnyCircumstance(2528, 1);
        AchievementHandler.activate(player, AchievementList.MONKEY_MADNESS, 1);//NEW ACHIEVEMNTS
        completed = true;
    }
