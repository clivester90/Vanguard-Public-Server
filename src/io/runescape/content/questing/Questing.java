...
import io.runescape.content.questing.LearningTheRopes.LearningTheRopesQuest;
import io.runescape.content.questing.hftd.HftdQuest;
import io.runescape.content.questing.MonkeyMadness.MonkeyMadnessQuest;
...
public class Questing {
    ...
    private static final List<Integer> QUEST_LIST_INTERFACE_IDS = Collections.unmodifiableList(Lists.newArrayList(
            183089, 183090, 183091, 50618, 50619, 50620, 50621));//50615
