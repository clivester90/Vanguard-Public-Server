package io.runescape.content.questing.LearningTheRopes;
...
import io.runescape.content.questing.Quest;
...
public class LearningTheRopesQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            case 0:
                lines.add("To start this quest talk to the "+ Configuration.SERVER_NAME+" Guide");
                lines.add("next to the teleport platform.");
                lines.add("");
                lines.add("Rewards:");
            ...
            case 4:
            case 5:
                lines.add("You still need to open all 4 of those interfaces");
                lines.add("found in the quest tab, and then general tab.");
                lines.add("Reminder:");
                lines.add("Collection Log, Monster Kill Log, Drop Table,");
                lines.add("Loot Table");
                break;
            case 6:
            ...
            if (option == 1) {
                if (getStage() == 0) {
                                            ...
                                            player.start(getXerosGuide()
                                                    ...
                                                    .option(new DialogueOption("Sure, I can start now!", e -> {
                                                                ...
                                                                e.start(getXerosGuide()
                                                                        ...
                                                                        .npc("The information these display", "will help you during your time in Koranes.")
                    ...
                    player.start(getXerosGuide()
                            ...
                            .npc(DialogueExpression.CALM, "For the shards!", "Items can be destroyed for points.")
