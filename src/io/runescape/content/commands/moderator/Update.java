...
public class Update extends Command {
	...
	public void execute(Player c, String commandName, String input) {
		...
		for (Player player : PlayerHandler.players) {
			...
			//Announcement.announce("@blu@Announcement - @red@the server is now being updated please force the update on the launcher.");
			//Discord.writeEventMessage("Announcement - the server is now being updated please force the update on the launcher.");
